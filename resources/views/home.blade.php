                ...
                <div class="card style-primary-dark">
                    <div class="card-body text-default-light ">
                        <div class="col-xs-4" role="alert">
                            <span>{{ __('Nombre Directions Provinciales') }}</span>
                                <p class="text-bold text-default-bright text-xxl"><strong>{{ $province['provinces'] }}</strong></p>
                            </div>
                        <div class="col-xs-4" role="alert">
                            <span>{{ __('Nombre Communes') }}</span>
                                <p class="text-bold text-default-bright text-xxl"><strong>{{ $province['communes'] }}</strong></p>
                            </div>
                        <div class="col-xs-4" role="alert">
                            <span>{{ __('Nombre Etablissements') }}</span>
                                <p class="text-ultra-bold text-default-bright text-xxl"><strong>{{ $province['etabs'] }}</strong></p>
                            </div>
                    </div><!--end .card-body -->
                </div>
            </div>
            <div class="row">
                <div class="card">
                    <div class="card-head card-head-xs style-primary-bright">
                        <header>{{ __('Information de l\'Academie') }}</header>
                        <div class="tools">
                            <div class="btn-group">
                                ...
                                <div class="card">
                                    <div class="card-body no-padding">
                                        <div class="alert alert-callout alert-info no-margin">
                                            ...
                                            <strong class="text-xxl">{{ __('الأكاديمية الجهوية لجهة الشرق') }}</strong><br>
                ...
                <div class="card">
                    <div class="card-head card-head-xs style-primary-light">
                        <header>{{ __('Détails Equipements') }}</header>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-xs-4">
