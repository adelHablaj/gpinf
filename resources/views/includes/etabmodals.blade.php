<div class="modal fade" id="suppmodal" tabindex="-1" role="dialog" aria-labelledby="formModalLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<form id="deleteetabForm" class="form-horizontal" action="{{ route('etabs.destroy', isset($etab->cd_etab)?$etab->cd_etab:0) }}" role="form" method="POST">
                @csrf
                @method('delete')
...
@if (isset($etab->cd_etab) && isset($nationalites))
	...
	<div class="modal-dialog">
		<div class="modal-content">
            ...
            <form method="POST" id="addTutorForm" class="form form-validate floating-label" action="{{ route('tuteurs.store')}}">
                @csrf
                <input type="hidden" name="etab_id" value="{{ $etab->cd_etab }}">
            <div class="card">
