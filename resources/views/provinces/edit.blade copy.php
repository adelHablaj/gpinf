@extends('layouts.app')
@section('pageTitle', 'Preinscription edition')
@push('smart_wizard-css')
    <!-- Form step -->
...
<div class="row">
    <div class="col-xl-12 col-xxl-12">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ isset($preinscription)?route('preinscriptions.update', $preinscription):route('preinscriptions.create')}}">
                    <div id="assistPreincription" class="form-wizard order-create">
