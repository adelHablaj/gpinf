@extends('layouts.app')
@section('pageTitle', __('Eleve Modification'))
@section('content')
    {{-- {{dd($eleve);}} --}}
    <div class="row">
        ...
        <div class="col-md-12">
            <form method="POST" class="form form-validate floating-label" action="{{ route('eleves.update', $eleve->id) }}">
                @csrf
                @method('PUT')
                <div class="card tabs-left">
                    <div class="card-head style-primary card-head-xs">
                        <header>{{ __('Eleve Modification') }}&nbsp;&nbsp;:&nbsp;&nbsp;<samp
                                class="text-light hidden-xs">{{ $eleve->prenom_fr . ' ' . $eleve->nom_fr }}</samp>&nbsp;&nbsp;<strong>{{ $eleve->massar }}</strong>
                        </header>
                    </div>
                        ...
                        <div class="tab-pane  active" id="profile">
                            <div class="row margin-1 text-center style-accent-bright border-gray  margin-bottom-xxl">
                                <div class="form-group col-md-2">
                                    <img id="photo-profile" src="{{ asset('images/students/' . $eleve->avatar) }}"
                                ...
                                <div class="form-group col-md-5">
                                    <h3 class="text-light text-left col-lg-12">
                                        {{ strtoupper($eleve->prenom_fr) . ' ' . strtoupper($eleve->nom_fr) }}</strong></h3>
                                    <div class="input-group padding-1">
                                        <div class="input-group-content">
                                            <input type="text" readonly class="form-control input-lg min-width-4"
                                                ...
                                                value="{{ old('massar') ? old('massar') : (isset($eleve->massar) ? $eleve->massar : '') }}"
                            ...
                            <div class="col-xs-12 margin-bottom-xxl">
                                <div class="form-group col-sm-6">
                                    <input type="text" class="form-control" id="prenom_fr" name="prenom_fr"
                                        value="{{ old('prenom_fr') ? old('prenom_fr') : (isset($eleve->prenom_fr) ? $eleve->prenom_fr : '') }}"
                                ...
                                <div class="form-group col-sm-6">
                                    <input type="text" class="form-control" id="nom_fr" name="nom_fr"
                                        value="{{ old('nom_fr') ? old('nom_fr') : (isset($eleve->nom_fr) ? $eleve->nom_fr : '') }}"
                                        data-rule-minlength="2" maxlength="100" required aria-required="true">
                            ...
                            <div class="col-xs-12  margin-bottom-xxl">
                                <div class="form-group col-sm-6">
                                    <input type="text" class="form-control text-right" id="prenom_ar"
                                        name="prenom_ar"
                                        value="{{ old('prenom_ar') ? old('prenom_ar') : (isset($eleve->prenom_ar) ? $eleve->prenom_ar : '') }}"
                                ...
                                <div class="form-group col-sm-6">
                                    <input type="text" class="form-control text-right" id="nom_ar" name="nom_ar"
                                        value="{{ old('nom_ar') ? old('nom_ar') : (isset($eleve->nom_ar) ? $eleve->nom_ar : '') }}"
                                        data-rule-minlength="2" maxlength="200" required aria-required="true">
                            ...
                            <div class="col-xs-12  margin-bottom-xxl">
                                <div class="form-group text-center col-sm-6">
                                    <div class="btn-group" data-toggle="buttons">
                                        <label
                                            class="btn btrad btn-xs ink-reaction btn-primary {{ old('genre') == 'Masculin' ? 'active' : ((isset($eleve->genre) ? $eleve->genre : '') == 'Masculin' ? 'active' : '') }} ">
                                            <input type="radio" value="Masculin" name="genre" id="male"
                                                {{ old('genre') == 'Masculin' ? 'checked=checked' : ((isset($eleve->genre) ? $eleve->genre : '') == 'Masculin' ? 'checked=checked' : '') }}><i
                                                class="fa fa-male fa-fw"></i> {{ __('Male') }}
                                        </label>
                                        <label
                                            class="btn btrad btn-xs ink-reaction btn-primary {{ old('genre') ? 'active' : ((isset($eleve->genre) ? $eleve->genre : '') == 'Féminin' ? 'active' : '') }}">
                                            <input type="radio" value="Féminin" name="genre" id="female"
                                                {{ old('genre') ? 'checked=checked' : ((isset($eleve->genre) ? $eleve->genre : '') == 'Féminin' ? 'checked=checked' : '') }}><i
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-content">
                                            <input type="date" class="form-control datepicker" id="date_nais"
                                                name="date_nais"
                                                value="{{ old('date_nais') ? old('date_nais') : (isset($eleve->date_nais) ? $eleve->date_nais : now()->format('Y-m-d')) }}"
                                        ...
                                        <div class="input-group-addon">
                                            <div id="agelabel" class="btn btn-sm btn-primary ">
                                                {{ old('age') ? old('age') : (isset($eleve->age) ? $eleve->age . __(' Years old') : '') }}
                                            </div>
                                            <input id="age" type="hidden" name="age"
                                                value="{{ old('age') ? old('age') : (isset($eleve->age) ? $eleve->age : '') }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xs-12  margin-bottom-xxl">
                                <div class="form-group col-sm-6">
                                    ...
                                    <select id="nationaliteEleve" name="nationalite_id"
                                        ...
                                        @foreach ($nationalites as $indx => $nationalite)
                                            <option
                                                {{ old('nationalite_id') == $indx ? 'selected=selected' : ((isset($eleve->nationalite_id) ? $eleve->nationalite_id : '') == $indx ? 'selected=selected' : '') }}
                                                value="{{ $indx }}">{{ $nationalite }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="form-group col-sm-6">
                                    <textarea class="form-control control-3-rows" id="adresse" name="adresse" required aria-required="true">{{ old('adresse') ? old('adresse') : (isset($eleve->adresse) ? $eleve->adresse : '') }}</textarea>
                        ...
                        <div class="tab-pane" id="school">
                            <div class="row margin-bottom-xxl">
                                <div class="form-group col-sm-4">
                                    ...
                                    <select id="niveau" name="niveau_id" class="default-select form-control" required
                                        ...
                                        @foreach ($eleve->niveaux as $indx => $niveau)
                                            <option
                                                {{ old('niveau_id') == $indx ? 'selected=selected' : ((isset($eleve->niveau_id) ? $eleve->niveau_id : '') == $indx ? 'selected=selected' : '') }}
                                ...
                                <div class="form-group col-sm-4">
                                    <input type="text" class="form-control" id="prevenance" name="prevenance"
                                        value="{{ old('prevenance') ? old('prevenance') : (isset($eleve->prevenance) ? $eleve->prevenance : '') }}"
                                        data-rule-minlength="2" maxlength="200" required aria-required="true">
                                ...
                                <div class="form-group col-sm-4">
                                    <input type="date" name="date_inscription" class="form-control datepicker"
                                        id="date_inscription"
                                        value="{{ old('date_inscription') ? old('date_inscription') : (isset($eleve->date_inscription) ? $eleve->date_inscription : now()->format('Y-m-d')) }}"
                                        required aria-required="true">
                            ...
                            <div class="row margin-bottom-xxl">
                                <div class="form-group">
                                    <textarea class="form-control control-6-rows" id="observation" name="observation">{{ old('observation') ? old('observation') : (isset($eleve->observation) ? $eleve->observation : '') }}</textarea>
                                                    ...
                                                    <div class="tile col-lg-12">
                                                        <a class="btn ink-reaction checkbox checkbox-styled">
                                                            <label><input
                                                                    ...
                                                                    {{ old('aut_quit_dej') == 1 ? 'checked' : (isset($eleve->aut_quit_dej) && $eleve->aut_quit_dej == 1 ? 'checked' : 0) }}>
                                                            </label>
                                                        </a>
                                                    ...
                                                    <div class="tile col-lg-12">
                                                        <a class="btn ink-reaction checkbox checkbox-styled">
                                                            <label><input name="aut_quit_fin_cours"
                                                                    ...
                                                                    value="1"
                                                                    {{ old('aut_quit_fin_cours') == 1 ? 'checked' : (isset($eleve->aut_quit_fin_cours) && $eleve->aut_quit_fin_cours == 1 ? 'checked' : 0) }}></label>
                                                        </a>
                                                        <a class="tile-content ink-reaction">
                                                            <div class="tile-icon">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="panel-group" id="tutors-panel">
                                        @foreach ($eleve->tuteurs as $key => $tuteur)
                                        ...
                                        <li class="tile">
                                            <a class="btn ink-reaction checkbox checkbox-styled">
                                                <label><input name="photo" id="photo" type="checkbox"
                                                        value="1"
                                                        {{ old('photo') == 1 ? 'checked' : (isset($eleve->photo) && $eleve->photo == 1 ? 'checked' : 0) }}></label>
                                            </a>
                                            <a class="tile-content ink-reaction">
                                                <div class="tile-icon">
                                        ...
                                        <li class="tile">
                                            <a class="btn ink-reaction checkbox checkbox-styled">
                                                <label><input name="extrait" id="extrait" type="checkbox"
                                                        value="1"
                                                        {{ old('extrait') == 1 ? 'checked' : (isset($eleve->extrait) && $eleve->extrait == 1 ? 'checked' : 0) }}></label>
                                            </a>
                                            <a class="tile-content ink-reaction">
                                                <div class="tile-icon">
                                        ...
                                        <li class="tile">
                                            <a class="btn ink-reaction checkbox checkbox-styled">
                                                <label><input name="cert_depart" id="cert_depart" type="checkbox"
                                                        value="1"
                                                        {{ old('cert_depart') == 1 ? 'checked' : (isset($eleve->cert_depart) && $eleve->cert_depart == 1 ? 'checked' : 0) }}></label>
                                            </a>
                                            <a class="tile-content ink-reaction">
                                                <div class="tile-icon">
                                        ...
                                        <li class="tile">
                                            <a class="btn ink-reaction checkbox checkbox-styled">
                                                <label><input name="ri_etab" id="ri_etab" type="checkbox"
                                                        value="1"
                                                        {{ old('ri_etab') == 1 ? 'checked' : (isset($eleve->ri_etab) && $eleve->ri_etab == 1 ? 'checked' : 0) }}></label>
                                            </a>
                                            <a class="tile-content ink-reaction">
                                                <div class="tile-icon">
                                        ...
                                        <li class="tile">
                                            <a class="btn ink-reaction checkbox checkbox-styled">
                                                <label><input name="enveloppe" id="enveloppe" type="checkbox"
                                                        value="1"
                                                        {{ old('enveloppe') == 1 ? 'checked' : (isset($eleve->enveloppe) && $eleve->enveloppe == 1 ? 'checked' : 0) }}></label>
                                            </a>
                                            <a class="tile-content ink-reaction">
                                                <div class="tile-icon">
                                        ...
                                        <li class="tile">
                                            <a class="btn ink-reaction checkbox checkbox-styled">
                                                <label><input name="dossier" id="dossier" type="checkbox"
                                                        value="1"
                                                        {{ old('dossier') == 1 ? 'checked' : (isset($eleve->dossier) && $eleve->dossier == 1 ? 'checked' : 0) }}></label>
                                            </a>
                                            <a class="tile-content ink-reaction">
                                                <div class="tile-icon">
                                                ...
                                                <li class="tile">
                                                    ...
                                                    <div class="form-group col-xs-3">
                                                        <input type="text" class="form-control" id="nbr_frere"
                                                            name="nbr_frere"
                                                            value="{{ old('nbr_frere') ? old('nbr_frere') : (isset($eleve->nbr_frere) ? $eleve->nbr_frere : '') }}"
                                                ...
                                                <li class="tile">
                                                    ...
                                                    <div class="form-group col-xs-3">
                                                        <input type="text" class="form-control" id="inscription"
                                                            name="inscription"
                                                            value="{{ old('inscription') ? old('inscription') : (isset($eleve->inscription) ? $eleve->inscription : '') }}"
                                                ...
                                                <li class="tile">
                                                    ...
                                                    <div class="form-group col-xs-3">
                                                        <input type="text" class="form-control" id="mensualite"
                                                            name="mensualite"
                                                            value="{{ old('mensualite') ? old('mensualite') : (isset($eleve->mensualite) ? $eleve->mensualite : '') }}"
                                                            data-rule-minlength="1" maxlength="100" required
                                                            aria-required="true">
                                                    </div>
                                                </li>
                                                ...
                                                <li class="tile">
                                                    ...
                                                    <div class="form-group col-xs-3">
                                                        <input type="text" class="form-control" id="bus"
                                                            name="bus"
                                                            value="{{ old('bus') ? old('bus') : (isset($eleve->bus) ? $eleve->bus : '') }}"
                                                            data-rule-minlength="1" maxlength="100" required
                                                            aria-required="true">
                                                    </div>
                                                </li>
                                                <li class="tile">
                                                    ...
                                                    <div class="form-group col-xs-3">
                                                        <input type="text" class="form-control" id="garde"
                                                            name="garde"
                                                            value="{{ old('garde') ? old('garde') : (isset($eleve->garde) ? $eleve->garde : '') }}"
                                                            data-rule-minlength="1" maxlength="100" required
                                                            aria-required="true">
                                                    </div>
                                                </li>
                                ...
                                <div class="card-body text-center no-padding">
                                    <div class="row margin-02">
                                        <div class="col-sm-05 col-sm-offset-1"><span
                                                ...
                                                class="btn btn-block btn-xs {{ $eleve->sumPayed >= $eleve->inscription && $eleve->inscription != 0 ? 'btn-success' : 'btn-danger' }}">{{ $eleve['inscriptionPayer'] ? $eleve['inscriptionPayer'] : 0 }}</button>
                                        </div>
                                        @foreach ($eleve['moisPayables'] as $mois => $montant)
                                            <div class="col-sm-05"><span
                                                    for="">{{ $mois }}</span><button type="button"
                                                    class="btn btn-block btn-xs {{ $montant != 0 ? ($montant < $eleve->aPayerParMois ? 'btn-warning' : 'btn-success') : 'btn-danger' }}">{{ $montant }}</button>
                                            </div>
                                        @endforeach
                                    </div>
                                    <br>
                                    <div class="row no-margin">
                                        <div class="table-responsive">
                                            <table class="table table-striped table-hover table-banded">
                                                ...
                                                <tbody>
                                                    @foreach ($eleve->paiement as $ipay => $paiement)
                                                        <tr>
                                                            <td>{{ $ipay + 1 }}</td>
                                                            <td>{{ $paiement->date }}</td>
                                                    ...
                                                    <tr class="info text-bold text-lg text-info">
                                                        ...
                                                        <td class="text-right"><span
                                                                class="text-bold">{{ $eleve->sumPayed }},00</span> DH
                                                        </td>
                                                        <td colspan="3"></td>
                                                    </tr>
                                                </tbody>
                    ...
                    <div class="card-actionbar stick-bottom-right hieght-4">
                        <div class="card-actionbar-row form-footer">
                            ...
                            <button type="button"
                                onclick="event.preventDefault(); document.getElementById('print-form-{{ $eleve->id }}').submit();"
            ...
            <form id="print-form-{{ $eleve->id }}"
                action="{{ route('eleves.print', [$eleve->id, 'certificate']) }}" method="get">@csrf</form>
            <form id="avatar-edit" action="{{ route('eleves.uploadavatar') }}" method="post"
                enctype="multipart/form-data">
                @csrf
                <input id="avatarfile" type="file" name="avatar" class="hide">
                <input id="eleve_id" type="hidden" name="eleve_id" value="{{ $eleve->id }}">
            </form>
        </div>
        <!--end .col -->
